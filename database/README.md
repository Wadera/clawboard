...
- Database reachable from the Docker network and from the host loopback only
- Host port mapping is bound to localhost (`127.0.0.1:5433` in docker-compose.yml)
