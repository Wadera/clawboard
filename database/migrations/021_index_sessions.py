...
SESSIONS_DIR = os.getenv('SESSIONS_DIR', '/home/clawd/.openclaw/agents/main/sessions')
DB_CONFIG = {
...
def main():
    ...
    DB_PASS = os.popen("grep POSTGRES_PASSWORD /home/clawd/clawd/projects/clawboard-nim/repo/.env | cut -d= -f2").read().strip()
