...
- **Channel:** `DISCORD_TASK_THREAD_CHANNEL_ID` env var (default: `#general` `1292093858154414153`)
- **Must be a standard text channel** (type 0) — announcements/forum channels don't support thread-create
- **Authorized steer users:** `DISCORD_ALLOWED_STEER_USERS` env var (default: `204643948960940033`)
...
|----------|---------|-------------|
| `DISCORD_TASK_THREAD_CHANNEL_ID` | `1292093858154414153` | Discord channel for task threads |
| `DISCORD_ALLOWED_STEER_USERS` | `204643948960940033` | User IDs that can steer via thread |
| `SPAWN_AGENT_ANNOUNCE_TO` | `user:204643948960940033` | Where to announce agent spawns |
...
to `ws://192.168.40.150:18789` directly.
