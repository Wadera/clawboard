...
> 📝 These screenshots show an example deployment with custom branding. Your instance will show your own bot name, colors, and branding as configured in `clawboard.config.json`.
