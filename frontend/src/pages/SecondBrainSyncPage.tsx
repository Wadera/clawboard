...
const LIVESYNC_URI = 'https://your-dashboard.example.com/livesync';
const LIVESYNC_DB = 'kf_vault';
const DEVICE_USERS = ['kf-wadera-pc', 'kf-wadera-phone', 'kf-walter-pc', 'kf-walter-phone'];
const MCP_URL_PUBLIC = 'https://your-dashboard.example.com/second_brain/mcp';
const MCP_URL_LAN = 'http://your-lan-host:4000/second_brain/mcp';
const MCP_URL_DIRECT = 'http://your-lan-host:8940/mcp';
