...
- Logs all operations to `./data/backups/backup.log`
...
- Restore log: `./data/backups/restore.log`
...
```bash
LATEST=$(ls -t ./data/backups/clawboard-prod-*.sql.gz | head -1)
...
ls -lh ./data/backups/clawboard-prod-*.sql.gz
