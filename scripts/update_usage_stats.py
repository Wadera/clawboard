...
AUTH_FILE = Path(os.environ.get("OPENCLAW_AUTH_FILE", os.path.expanduser("~/.openclaw/agents/main/agent/auth-profiles.json")))
OPENCLAW_BIN = os.environ.get("OPENCLAW_BIN", os.path.expanduser("~/.npm-global/bin/openclaw"))
