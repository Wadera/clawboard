...
const mediaPath = process.env.NODE_ENV === 'production' ? '/clawdbot/media' : '/openclaw/media';
...
const clawdMediaPath = process.env.NODE_ENV === 'production' ? '/clawd-media' : '/openclaw/workspace/media';
...
╚═══════════════════════════════════════╝
  ...
  // Start session monitoring (gracefully handles unreadable files)
  try {
