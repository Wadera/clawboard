...
elif [ -f /workspace/projects/clawboard/repo/cli/clawboard ]; then
  CB="python3 /workspace/projects/clawboard/repo/cli/clawboard"
...
that are not already in a ClawBoard report, record them wherever your team
...
- **NEVER** call the ClawBoard API directly with curl — always use the CLI
