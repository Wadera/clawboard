...
**CLI:** \`clawboard\` (or \`python3 /path/to/clawboard/cli/clawboard\`)
...
CB="clawboard"  # or: python3 /path/to/clawboard/cli/clawboard
\`\`\`
The CLAWBOARD_AGENT=1 flag enforces agent restrictions (prevents you from marking tasks completed).
